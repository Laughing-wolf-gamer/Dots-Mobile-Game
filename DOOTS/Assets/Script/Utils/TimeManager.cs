    ...
    public class TimeManager : MonoBehaviour {
        ...
        private void Update(){
            if(!canClick){
                ...
                long diff = ((long)System.DateTime.Now.Ticks - lastTimeClicked);
        ...
        public void Click() {
            if(!isAlreadyClickd){
                lastTimeClicked = (long)System.DateTime.Now.Ticks;
                PlayerPrefs.SetString(timerName, lastTimeClicked.ToString());
                canClick = false;
                isAlreadyClickd = true;
            }
